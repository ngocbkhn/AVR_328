...
; 0000 0035 DDRC=(0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (0<<DDC2) | (0<<DDC1) | (0<<DDC0);
	OUT  0x7,R30
; 0000 0036 // State: Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=T
...
_0x13:
	...
	BRGE _0x14
; 0000 00A9             {
; 0000 00AA                 PORTD = LED7SEGCA[i/1000];
	__GETW2R 3,4
	LDI  R30,LOW(1000)
	LDI  R31,HIGH(1000)
	RCALL SUBOPT_0x0
...
; 0000 00AD                 PORTB.0 = 1;
	SBI  0x5,0
; 0000 00AE 
; 0000 00AF                 PORTD = LED7SEGCA[(i%1000)/100];
	__GETW2R 3,4
	LDI  R30,LOW(1000)
	LDI  R31,HIGH(1000)
	CALL __MODW21
...
; 0000 00B2                 PORTB.1 = 1;
	SBI  0x5,1
; 0000 00B3 
; 0000 00B4                 PORTD = LED7SEGCA[(i%100)/10];
	__GETW2R 3,4
	LDI  R30,LOW(100)
	LDI  R31,HIGH(100)
	CALL __MODW21
...
; 0000 00B7                 PORTB.2 = 1;
	SBI  0x5,2
; 0000 00B8 
; 0000 00B9                 PORTD = LED7SEGCA[i%10];
	__GETW2R 3,4
	LDI  R30,LOW(10)
	LDI  R31,HIGH(10)
	CALL __MODW21
