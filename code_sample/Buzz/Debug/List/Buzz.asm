...
; 0000 0031 // Function: Bit6=In Bit5=In Bit4=In Bit3=In Bit2=Out Bit1=In Bit0=In
; 0000 0032 DDRC=(0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (1<<DDC2) | (0<<DDC1) | (0<<DDC0);
	LDI  R30,LOW(4)
	OUT  0x7,R30
; 0000 0033 // State: Bit6=T Bit5=T Bit4=T Bit3=T Bit2=0 Bit1=T Bit0=T
...
_0x3:
; 0000 009C       {
; 0000 009D        if (PINC.0 == 0)
	SBIC 0x6,0
	RJMP _0x6
; 0000 009E        {
; 0000 009F             PORTC.2 = !PORTC.2;
	SBIS 0x8,2
	RJMP _0x7
	CBI  0x8,2
	RJMP _0x8
