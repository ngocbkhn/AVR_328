...
_0x0:
	.DB  0x4E,0x47,0x4F,0x43,0x56,0x4D,0x32,0x20
	.DB  0x2D,0x20,0x44,0x55,0x59,0x44,0x4B,0x32
	.DB  0x0,0x54,0x41,0x4E,0x4D,0x4C,0x32,0x20
	.DB  0x2D,0x20,0x48,0x4F,0x41,0x44,0x56,0x37
	.DB  0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0044 TCCR0A=(0<<COM0A1) | (0<<COM0A0) | (0<<COM0B1) | (0<<COM0B0) | (0<<WGM01) | (0<<WGM00);
	OUT  0x24,R30
; 0000 0045 TCCR0B=(0<<WGM02) | (0<<CS02) | (0<<CS01) | (0<<CS00);
	OUT  0x25,R30
...
; 0000 0067 ASSR=(0<<EXCLK) | (0<<AS2);
	STS  182,R30
; 0000 0068 TCCR2A=(0<<COM2A1) | (0<<COM2A0) | (0<<COM2B1) | (0<<COM2B0) | (0<<WGM21) | (0<<WGM20);
	STS  176,R30
; 0000 0069 TCCR2B=(0<<WGM22) | (0<<CS22) | (0<<CS21) | (0<<CS20);
	STS  177,R30
...
; 0000 006F TIMSK0=(0<<OCIE0B) | (0<<OCIE0A) | (0<<TOIE0);
	STS  110,R30
; 0000 0070 
; 0000 0071 // Timer/Counter 1 Interrupt(s) initialization
; 0000 0072 TIMSK1=(0<<ICIE1) | (0<<OCIE1B) | (0<<OCIE1A) | (0<<TOIE1);
	STS  111,R30
; 0000 0073 
; 0000 0074 // Timer/Counter 2 Interrupt(s) initialization
; 0000 0075 TIMSK2=(0<<OCIE2B) | (0<<OCIE2A) | (0<<TOIE2);
	STS  112,R30
; 0000 0076 
; 0000 0077 // External Interrupt(s) initialization
; 0000 0078 // INT0: Off
; 0000 0079 // INT1: Off
; 0000 007A // Interrupt on any change on pins PCINT0-7: Off
; 0000 007B // Interrupt on any change on pins PCINT8-14: Off
; 0000 007C // Interrupt on any change on pins PCINT16-23: Off
; 0000 007D EICRA=(0<<ISC11) | (0<<ISC10) | (0<<ISC01) | (0<<ISC00);
	STS  105,R30
; 0000 007E EIMSK=(0<<INT1) | (0<<INT0);
	OUT  0x1D,R30
; 0000 007F PCICR=(0<<PCIE2) | (0<<PCIE1) | (0<<PCIE0);
	STS  104,R30
; 0000 0080 
; 0000 0081 // USART initialization
; 0000 0082 // USART disabled
; 0000 0083 UCSR0B=(0<<RXCIE0) | (0<<TXCIE0) | (0<<UDRIE0) | (0<<RXEN0) | (0<<TXEN0) | (0<<UCSZ02) | (0<<RXB80) | (0<<TXB80);
	STS  193,R30
; 0000 0084 
...
; 0000 008B ACSR=(1<<ACD) | (0<<ACBG) | (0<<ACO) | (0<<ACI) | (0<<ACIE) | (0<<ACIC) | (0<<ACIS1) | (0<<ACIS0);
	LDI  R30,LOW(128)
	OUT  0x30,R30
; 0000 008C ADCSRB=(0<<ACME);
	LDI  R30,LOW(0)
	STS  123,R30
; 0000 008D // Digital input buffer on AIN0: On
; 0000 008E // Digital input buffer on AIN1: On
; 0000 008F DIDR1=(0<<AIN0D) | (0<<AIN1D);
	STS  127,R30
; 0000 0090 
...
; 0000 00A0 // RS - PORTD Bit 6
; 0000 00A1 // RD - PORTD Bit 5
; 0000 00A2 // EN - PORTD Bit 4
; 0000 00A3 // D4 - PORTD Bit 3
; 0000 00A4 // D5 - PORTD Bit 2
; 0000 00A5 // D6 - PORTD Bit 1
; 0000 00A6 // D7 - PORTD Bit 0
...
_0x3:
; 0000 00AC       {
; 0000 00AD       if (PINC.0 == 0)
	SBIC 0x6,0
	RJMP _0x6
; 0000 00AE       {
; 0000 00AF       lcd_clear();
	RCALL _lcd_clear
; 0000 00B0       lcd_puts("NGOCVM2 - DUYDK2");
	__POINTW2MN _0x7,0
	RCALL _lcd_puts
; 0000 00B1       lcd_gotoxy(0,1);
	...
	LDI  R26,LOW(1)
	RCALL _lcd_gotoxy
; 0000 00B2       lcd_puts("TANML2 - HOADV7");
	__POINTW2MN _0x7,17
	RCALL _lcd_puts
; 0000 00B3       }
; 0000 00B4       }
